...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "name",
            sa.Enum("manual", "zoom", "google", "teams", name="provider_name"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_levels_language_id"), "levels", ["language_id"], unique=False
    )
    op.create_table(
        "courses",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "payment_status",
            sa.Enum("pending", "paid", "overdue", name="payment_status"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_schedules_teacher_id"), "schedules", ["teacher_id"], unique=False
    )
    op.create_table(
        "attendance",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_grades_enrollment_id"), "grades", ["enrollment_id"], unique=False
    )
    op.create_table(
        "virtual_meetings",
        sa.Column("id", sa.Integer(), nullable=False),
        ...
        sa.Column(
            "status",
            sa.Enum("scheduled", "live", "ended", "cancelled", name="meeting_status"),
            nullable=False,
        ),
        sa.Column("recording_url", sa.Text(), nullable=True),
        sa.ForeignKeyConstraint(
            ["provider_id"], ["meeting_providers.id"], ondelete="RESTRICT"
        ),
        sa.ForeignKeyConstraint(["schedule_id"], ["schedules.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        op.f("ix_virtual_meetings_provider_id"),
        "virtual_meetings",
        ["provider_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_virtual_meetings_schedule_id"),
        "virtual_meetings",
        ["schedule_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["meeting_id"], ["virtual_meetings.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(["user_id"], ["users.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        op.f("ix_meeting_logs_meeting_id"), "meeting_logs", ["meeting_id"], unique=False
    )
    op.create_index(
        op.f("ix_meeting_logs_user_id"), "meeting_logs", ["user_id"], unique=False
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_virtual_meetings_schedule_id"), table_name="virtual_meetings"
    )
    op.drop_index(
        op.f("ix_virtual_meetings_provider_id"), table_name="virtual_meetings"
    )
