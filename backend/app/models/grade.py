...
class Grade(Base):
    ...
    # Declared on the model (not left to autogenerate) so the partial unique
    # indexes are not read as drift and dropped again: an autogenerated
    # migration once deleted them and regrading broke on fresh deployments.
    __table_args__ = (
        Index(
            "uq_grade_session",
            "enrollment_id",
